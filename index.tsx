                ...
                <div className="chat-window">
                    ...
                    <div className="chat-body" ref={chatBodyRef}>
                        {messages.map((msg, index) => (
                            // FIX: Explicitly cast the result of marked.parse() to a string. This resolves a TypeScript
                            // error where the argument was being inferred as 'unknown', likely due to a type definition issue.
                            <div key={index} className={`chat-message ${msg.type}`} dangerouslySetInnerHTML={{ __html: msg.type === 'model' ? String(marked.parse(msg.text)) : msg.text }}></div>
                        ))}
